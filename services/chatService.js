...
4. 무슨 일이 있어도 HTML 형식으로 작성해줘. <br> 태그를 사용해서 줄바꿈을 명시해줘.

요금제 추천 결과  시
- 요금제 추천 결과를 **리스트로 정리**하고 간결하게 설명
- 추천 요금제가 여러 개인 경우 반드시 **리스트 형태**로 정리하고, 한두 줄로 추천 이유를 정리
